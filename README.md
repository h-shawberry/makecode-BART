...
<p>
  <img src="images/BalloonBART.png" alt="BART Balloon" width="300">
  <img src="images/PopBART.png" alt="BART Pop" width="300">
</p>
...
- Computer/Tablet with internet access so you can visit [makecode.microbit.org](https://makecode.microbit.org)
...
<img src="images/Screenshot 2026-03-14 at 16.06.13.png" alt="Screenshot of micro:bit data log page" width="600">

# **Step 2: Code it**

1) **Function: `FullReset()`**

<img src="images/FullReset.png" alt="FullReset function blocks" width="600">

2) **Function: `Instructions()`**

<img src="images/Instructions.png" alt="Instructions function blocks" width="274">

3) **Function: `RoundEnd()`**

<img src="images/RoundEnd.png" alt="RoundEnd function blocks" width="600">

4) **Function: `showBallonLevelLED()`** This is one long block in makecode, represented here in 2 columns:

<img src="images/1showBalloonLEDs-01.png" alt="First column of showBallonLevelLED blocks" width="250"> <img src="images/2showBalloonLEDs.png" alt="Second column of showBallonLevelLED blocks" width="250">

5) Function: `HappyEnd()`

<img src="images/HappyEnd-3.png" alt="HappyEnd function blocks" width="600">

6) Button A: **Pump**

<img src="images/ButtonA.png" alt="Button A pump logic" width="600">

7) Button B: **Bank**

<img src="images/ButtonB.png" alt="Button B bank logic" width="600">

8) **Forever Loop:**

<img src="images/Forever.png" alt="Forever loop logic" width="507">

9) **On Start:**

<img src="images/onStart.png" alt="On start logic" width="408">
...
<img src="images/EasyHard.png" alt="Random range settings to adjust difficulty" width="500">
